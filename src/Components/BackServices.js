    ...
    render() {
        return (
            ...
            <Container style={{marginTop: 80}} className="BackService">
                <Col>
                    <h1 style={{paddingBottom:80, textAlign:'center'}}>Our Services</h1>
                </Col>
                <Row style={{paddingBottom: 200}}>
                    <Col md={6}  sm={0} xs={0} className="para" style={{backgroundImage: "url(" + require('../img/city.jpg') + ")",}}>
                            

                    </Col>

                    <Col md={6} sm={12} xs={12}>
                        <h1 style={{paddingBottom:80, textAlign:'center', fontFamily:'Montserrat'}}>Hotel Services</h1>
