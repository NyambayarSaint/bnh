...
import axios from 'axios'
 ...
 class News extends Component {
    ...
    componentDidMount() {
        axios('http://66.181.166.84:1337/company-news').then((Response) => {
            this.setState({
                LatesNews : Response.data
            })
        })
    }
                ...
                <Col md={7}>
                    ...
                    {this.state.LatesNews.map((el,i) => {
                        ...
                        <div style={{padding: '5px 0px'}}>
                                ...
                                <p>Semper ac dolor vitae accumsan. interdum hendrerit lacinia. Semper dolor vitae accumsan. Aenean ac tortor at tellus feugiat.</p>
